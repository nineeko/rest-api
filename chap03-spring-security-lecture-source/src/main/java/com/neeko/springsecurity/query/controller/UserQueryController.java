package com.neeko.springsecurity.query.controller;
...
import com.neeko.springsecurity.query.service.UserQueryService;
...
public class UserQueryController {
    ...
    public ResponseEntity<ApiResponse<UserDetailResponse>> getUserDetail(
            // 인증 필터를 거치고 나면 Spring Security Context에 인증 객체가 저장되어 있음
            // 필요하다면 UserDetails <- User <- CustomUser의 형태로 상속(확장)해서
    ...
    // 간단한 URL 패턴보다 복잡한 비즈니스 로직이나 매서드 단위의 세밀한 보안 제어가 필요한 경우
